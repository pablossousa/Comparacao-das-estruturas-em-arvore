...
void calcular50000entradas()
{
	...
	ifstream arquivo50000um(PATH "entrada50000.txt");

	if (arquivo50000um.is_open()) {
		while (getline(arquivo50000um, linha)) {
			aux = stof(linha);
			r.key = aux;
			r.value = 1;
	...
	ifstream arquivo50000dois(PATH "entrada50000.txt");

	if (arquivo50000dois.is_open()) {
		while (getline(arquivo50000dois, linha)) {
			aux = stof(linha);
			r.key = aux;
			r.value = 1;
	...
	ifstream arquivo50000tres(PATH "entrada50000.txt");

	if (arquivo50000tres.is_open()) {
		while (getline(arquivo50000tres, linha)) {
			aux = stof(linha);
			r.key = aux;
			r.value = 1;
	...
	ifstream arquivo50000seis(PATH "entrada50000.txt");

	if (arquivo50000seis.is_open()) {
		while (getline(arquivo50000seis, linha)) {
			aux = stof(linha);
			r.key = aux;
			r.value = 1;
			vetor.push_back(aux);
	...
	ifstream arquivo50000quatro(PATH "entrada50000.txt");

	if (arquivo50000quatro.is_open()) {
		while (getline(arquivo50000quatro, linha)) {
			aux = stof(linha);
			r.key = aux;
			r.value = 1;
			mapa.insert({aux, 0});
	...
	ifstream arquivo50000cinco(PATH "entrada50000.txt");

	if (arquivo50000cinco.is_open()) {
		while (getline(arquivo50000cinco, linha)) {
			aux = stof(linha);
			r.key = aux;
			r.value = 1;
			mapaNO.insert({aux, 0});
	...
	// ifstream arquivo50000cinco1(PATH "entrada50000.txt");

	// unordered_map <double, int>::iterator k;

	// if (arquivo50000cinco1.is_open()) {
	// 	while (getline(arquivo50000cinco1, linha)) {
	// 		aux = stof(linha);
	// 		cout << aux << endl;
	// 	}
	// }
